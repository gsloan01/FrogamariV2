...
public class Select : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            ...
            selectLevelUpCanvas.transform.DOMove(new Vector3(selectLevelUpCanvas.transform.position.x - 300, selectLevelUpCanvas.transform.position.y, selectLevelUpCanvas.transform.position.z), 2f);
            //Debug.Log("Entered");
        }
    }
